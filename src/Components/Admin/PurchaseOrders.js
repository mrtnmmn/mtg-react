    ...
    return (
        <div>
            {props.admin ? (
                                ...
                                {selectedItemDecks.length !== 0 ? (
                                    <div className="selectedItemDecks">
                                        ...
                                        {selectedItemDecks.map((deck) => {
                                            return (
                                                <div className="purchaseOrderDeck">
                                                    <div className="purchaseOrderDeckName">
                                                        Deck name:{" "}
                                                        {deck.deckName}
                                                    </div>
                                                    <div>
                                                        {deck.cards.map(
                                                            (card) => {
                                                                return (
                                                                    <div
                                                                        className="selectedDeckCardListItem"
                                                                        onClick={() => {
                                                                            selectCard(
                                                                                card.cardName
                                                                            )
                                ...
                                {selectedItemCards.length !== 0 ? (
                                    <div className="selectedItemDecks">
                                        ...
                                        {selectedItemCards.map((card) => {
                                            return (
                                                <div
                                                    className="selectedItemCardList"
                                                    onClick={() => {
                                ...
                                {stock ? (
                                    <div className="submitButtonDiv">
                                        <CustomButton
                                            class={"green"}
                                            text={"Submit order"}
                                            buttonFunction={submitOrder}
                                        />
                                    </div>
                                ) : (
                                    <div className="sectionTitle">
                                        Not enougth stock to submit
                                    </div>
                                )}
                            </div>
                        ) : (
                ...
                <div className="notAdmin">You are not an admin</div>
            )}
        </div>
    )
}
